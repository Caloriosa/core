...
var INVALID_DATA = HttpResponseStatus{HttpCode: http.StatusUnprocessableEntity, Type: "INVALID_DATA", Message: "Invalid data"}
var DATA_PARSE_ERROR = HttpResponseStatus{HttpCode: http.StatusBadRequest, Type: "DATA_PARSE_ERROR", Message: "Error during parsing data (syntax error in JSON)"}
var INVALID_CREDENTIALS = HttpResponseStatus{HttpCode: http.StatusUnprocessableEntity, Type: "INVALID_CREDENTIALS", Message: "Invalid credentials (login, password)"}
var INVALID_TOKEN = HttpResponseStatus{HttpCode: http.StatusUnprocessableEntity, Type: "INVALID_TOKEN", Message: "Your token is not valid"}
...
var PASSWORD_REQUIRED = HttpResponseStatus{HttpCode: http.StatusUnprocessableEntity, Type: "PASSWORD_REQUIRED", Message: "Password required to access this resource!"}
var WEAK_PASSWORD = HttpResponseStatus{HttpCode: http.StatusUnprocessableEntity, Type: "WEAK_PASSWORD", Message: "Chosen password is too weak"}
var INVALID_PASSWORD = HttpResponseStatus{HttpCode: http.StatusUnprocessableEntity, Type: "INVALID_PASSWORD", Message: "Chosen password is not valid"}
var INVALID_USERNAME = HttpResponseStatus{HttpCode: http.StatusUnprocessableEntity, Type: "INVALID_USERNAME", Message: "Chosen username is not valid"}
var INVALID_EMAIL = HttpResponseStatus{HttpCode: http.StatusUnprocessableEntity, Type: "INVALID_EMAIL", Message: "Your email is not valid"}
...
var BUSY = HttpResponseStatus{HttpCode: http.StatusTooManyRequests, Type: "BUSY", Message: "Service is busy"}
var SERVER_ERROR = HttpResponseStatus{HttpCode: http.StatusInternalServerError, Type: "SERVER_ERROR", Message: "Internal Server Error"}
var INVALID_SIGNATURE = HttpResponseStatus{HttpCode: http.StatusUnprocessableEntity, Type: "INVALID_SIGNATURE", Message: "Invalid application signature"}
var MISSING_REQUIRED = HttpResponseStatus{HttpCode: http.StatusUnprocessableEntity, Type: "MISSING_REQUIRED", Message: "Required field is missing"}
